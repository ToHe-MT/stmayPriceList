<script>
	...
	import img201 from '../lib/paintings/201.jpg?enhanced';
	...
	<div class="mt-24">
		<div class=" md:container md:mx-auto px-4 sm:px-8 md:px-8 lg:max-w-[800px] xl:max-w-[800px]">
			<div class="flex flex-col w-full">
				<span class="text-3xl font-bold font-sans">Price List</span>
				<span class="font-medium font-sans text-xl">Newest works available : </span>
				<span class="italic font-sans"
					>*Price does not include shipping costs from Indonesia and PayPal tax
				</span>
			</div>
		</div>
	</div>
...
{#each paintings as item}
	<OnView>
		<div class="my-12">
			<div
				class=" md:container md:mx-auto px-4 sm:px-8 md:px-8 lg:max-w-[800px] xl:max-w-[800px] min-h-96"
			>
				<div class="flex flex-col w-full">
					{#if item.img}
						<enhanced:img src={item.img} alt="" it s />
					{:else}
...
<div
	class=" md:container md:mx-auto px-4 sm:px-8 md:px-8 lg:max-w-[800px] xl:max-w-[800px] grid grid-cols-1 md:grid-cols-2 gap-8 my-12"
>
